            ...
            <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
                <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-pink-50">
                    <h2 className="text-lg font-bold text-pink-700">
                        {editingProduct ? "Chá»‰nh sá»­a sáº£n pháº©m" : "ThÃªm sáº£n pháº©m má»›i"}
                    </h2>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="Bá»‰m tÃ£">Bá»‰m tÃ£</option>
                            <option value="Sá»¯a cÃ´ng thá»©c">Sá»¯a cÃ´ng thá»©c</option>
                            <option value="Äá»“ sÆ¡ sinh">Äá»“ sÆ¡ sinh</option>
                        </select>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Tá»“n kho tá»‘i thiá»ƒu</label>
                            <input
                                type="number"
                                name="minStock"
                                required
