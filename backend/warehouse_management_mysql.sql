...
VALUES
    ('goods_receipts:confirm', 'Xác nhận phiếu nhập', 'goods_receipts', 'Xác nhận phiếu nhập và cộng tồn kho'),
    ('goods_receipts:reverse', 'Đảo phiếu nhập', 'goods_receipts', 'Đảo phiếu nhập đã xác nhận, trừ lại tồn kho'),
    ('goods_issues:confirm', 'Xác nhận phiếu xuất', 'goods_issues', 'Xác nhận phiếu xuất và trừ tồn kho'),
    ('goods_issues:reverse', 'Đảo phiếu xuất', 'goods_issues', 'Đảo phiếu xuất đã xác nhận, hoàn lại tồn kho'),
    ('stock_transfers:confirm', 'Xác nhận phiếu chuyển kho', 'stock_transfers', 'Xác nhận chuyển hàng giữa hai vị trí'),
    ('stock_transfers:reverse', 'Đảo phiếu chuyển kho', 'stock_transfers', 'Đảo phiếu chuyển kho đã xác nhận'),
    ('stock_adjustments:approve', 'Duyệt phiếu điều chỉnh', 'stock_adjustments', 'Duyệt phiếu điều chỉnh và cập nhật tồn kho'),
    ('stock_adjustments:reject', 'Từ chối phiếu điều chỉnh', 'stock_adjustments', 'Từ chối phiếu điều chỉnh trước khi tồn kho thay đổi'),
    ('stock_adjustments:cancel', 'Hủy phiếu điều chỉnh', 'stock_adjustments', 'Hủy phiếu điều chỉnh còn ở trạng thái nháp hoặc chờ duyệt'),
    ('stock_counts:create', 'Tạo phiếu kiểm kê', 'stock_counts', 'Tạo phiếu kiểm kê và chốt số liệu tồn tại thời điểm đó'),
    ('stock_counts:start', 'Bắt đầu kiểm kê', 'stock_counts', 'Chuyển phiếu kiểm kê sang trạng thái đang kiểm kê'),
    ('stock_counts:count', 'Ghi số đếm kiểm kê', 'stock_counts', 'Nhập số lượng đếm thực tế cho từng dòng'),
    ('stock_counts:submit', 'Gửi duyệt kiểm kê', 'stock_counts', 'Nộp kết quả đếm để chờ duyệt'),
    ('stock_counts:approve', 'Duyệt phiếu kiểm kê', 'stock_counts', 'Duyệt kết quả kiểm kê và sinh phiếu điều chỉnh cho phần lệch'),
    ('users:read', 'Xem nhân viên', 'auth', 'Xem danh sách tài khoản nhân viên'),
    ...
    ('warehouses:update', 'Sửa kho', 'warehouses', 'Cập nhật thông tin kho'),
    ('warehouses:delete', 'Xóa kho', 'warehouses', 'Ngừng hoạt động một kho'),
    ('settings:update', 'Sửa tham số hệ thống', 'settings', 'Thay đổi cấu hình chung của hệ thống'),
    ('alerts:generate', 'Sinh cảnh báo tồn kho', 'alerts', 'Quét dữ liệu tồn để sinh cảnh báo tồn thấp và hàng cận hạn'),
    ('alerts:read', 'Đánh dấu đã đọc cảnh báo', 'alerts', 'Đánh dấu một cảnh báo là đã đọc'),
    ('alerts:resolve', 'Xử lý cảnh báo', 'alerts', 'Đóng cảnh báo tồn kho sau khi đã xử lý'),
    ('notifications:generate', 'Sinh thông báo', 'notifications', 'Sinh thông báo từ các cảnh báo đang mở'),
    ('notifications:read', 'Đánh dấu đã đọc thông báo', 'notifications', 'Đánh dấu một thông báo là đã đọc')
