            ...
            <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
                ...
                <div className="p-6 grid grid-cols-2 gap-y-4 gap-x-8 text-sm">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="font-semibold text-gray-800">{selectedTransaction.loai === "NHAP" ? "Cong ty Sửa Vinamilk" : "N/A"}</p>
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="col-span-2 pt-4 border-t border-gray-100">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {selectedTransaction.items && selectedTransaction.items.length > 0 ? (
                                Array.from(new Set(selectedTransaction.items.map(item => getProductCategoryLabel(item.category)))).map((cat) => (
                    ...
                    <div className="col-span-2 space-y-2">
                        <p className="text-gray-500 font-medium">Sản phẩm và vị trí lưu trữ:</p>
                                ...
                                selectedTransaction.items.map((item, idx) => (
                                    <div key={idx} className="flex justify-between text-xs py-1 border-b border-gray-100 last:border-0">
                                        <div>
                                            ...
                                            <span className="text-gray-500 ml-2">({getProductNameLabel(item.name)})</span>
                                        </div>
