import type { Shelf, Layer } from "../../../../hooks/useWarehouse";
...
export default function StructureSidebar({
    ...
    return (
        <div className="w-72 bg-white border-r border-gray-200 p-4 overflow-y-auto">
            <h2 className="font-semibold text-sm text-gray-500 uppercase mb-3">Cấu trúc nhanh</h2>
