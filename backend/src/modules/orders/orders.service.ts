...
export async function updateOrder(
    ...
    try {
        return await updateOrderRepository(
            id,
            input,
        );
    } catch (error) {
...
export async function confirmOrder(
    ...
    try {
        return await confirmOrderRepository(
            id,
            userId,
        );
    } catch (error) {
...
export async function processOrder(
    ...
    try {
        return await processOrderRepository(
            id,
            userId,
        );
    } catch (error) {
...
export async function cancelOrder(
    ...
    try {
        return await cancelOrderRepository(
            id,
            userId,
        );
    } catch (error) {
...
export async function completeOrder(
    ...
    try {
        return await completeOrderRepository(
            id,
            userId,
        );
    } catch (error) {
...
export async function createGoodsIssueFromOrder(
    ...
    try {
        return await insertGoodsIssueFromOrder(
            input,
        );
    } catch (error) {
        return mapError(error);
